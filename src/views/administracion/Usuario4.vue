    ...
    <template v-slot:bottom>
      ...
      <v-dialog v-model="dialog" max-width="500px">
        <template v-slot:activator="{ on, attrs }">
          <v-btn color="primary" dark class="mb-2" v-bind="attrs" v-on:click="addItem">
            New Item
          </v-btn>
...
export default {
  ...
  data: () => ({
    ...
    headers: [
      ...
      { title: 'Ap. Paterno', key: 'apPaterno' },
      { title: 'Ap. Materno', key: 'Apmaterno' },
      { title: 'Nombres', key: 'nombres' },
      { title: 'Rol Asignado', key: 'rolAsignado' },
    ...
    desserts: [],
    editedIndex: -1,
    editedItem: {  // ... propiedades del formulario
      name: '',
      calories: 0,
      fat: 0,
      carbs: 0,
