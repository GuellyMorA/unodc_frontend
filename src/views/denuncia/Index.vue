...
// Función para habilitar/deshabilitar  GES_SEGNAL
const desabilitarxx = () => {
  console.log('SEG rol', rol)
  isDisabled1.value =   rol.substring (0,7) === 'GES_DEP'  ? false : true; // derivacion
  isDisabled2.value = rol === 'TRANSP_NAL' || rol === 'DIRECT_NAL' || rol === 'GES_SEGNAL' || rol.substring (0,7) === 'GES_DEP' || rol.substring (0,7) === 'SEG_DEP'  ? false : true; // seguimiento
